...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `staff`(`id`, `name`, `email`, `mobile`, `password`, `note`, `department`,`position`) 
    VALUES ('$id','$name','$email','$mobile','$password','$note','$department','$position')";
...
<div class="container my-5">
       <form method="post">
        ...
        <input type="text" class="form-control" name="name" placeholder="enter your staff"
        autocomplete ="off">
        </div>
        <div class="mb-3">
        ...
        <input type="text" class="form-control" name="position" placeholder="enter your current position"
        autocomplete ="off">
